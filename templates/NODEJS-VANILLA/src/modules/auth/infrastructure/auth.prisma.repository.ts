...
function mapPrismaUserToEntity(user: any): IUserEntity {
  return {
    id: user.id,
    name: user.name,
    email: user.email,
...
function mapPrismaAccountToEntity(account: any): IAccountEntity {
  return {
    id: account.id,
...
function mapPrismaSessionToEntity(session: any): ISessionEntity {
  return {
    id: session.id,
...
function mapPrismaVerificationToEntity(verification: any): IVerificationEntity {
  return {
    id: verification.id,
